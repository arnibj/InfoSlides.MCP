...
[JsonSerializable(typeof(SlideRule))]
[JsonSerializable(typeof(List<SlideRule>))]
[JsonSerializable(typeof(Screen))]
[JsonSerializable(typeof(List<Screen>))]
[JsonSerializable(typeof(Ticker))]
[JsonSerializable(typeof(Clock))]
[JsonSerializable(typeof(Source))]
[JsonSerializable(typeof(List<Source>))]
[JsonSerializable(typeof(UpdateSlideRequest))]
...
[JsonSerializable(typeof(PushReceived))]
[JsonSerializable(typeof(PushSourceStatus))]
[JsonSerializable(typeof(CreatePushKeyRequest))]
